...
func (load *AALOAD) Execute(frame *Frame) {
...
func (load *BALOAD) Execute(frame *Frame) {
	stack := frame.OperandStack()
	index := stack.PopInt()
	arrRef := stack.PopRef()
...
func (load *CALOAD) Execute(frame *Frame) {
	stack := frame.OperandStack()
	index := stack.PopInt()
	arrRef := stack.PopRef()
...
func (load *DALOAD) Execute(frame *Frame) {
	stack := frame.OperandStack()
	index := stack.PopInt()
	arrRef := stack.PopRef()
...
func (load *FALOAD) Execute(frame *Frame) {
	stack := frame.OperandStack()
	index := stack.PopInt()
	arrRef := stack.PopRef()
...
func (load *IALOAD) Execute(frame *Frame) {
	stack := frame.OperandStack()
	index := stack.PopInt()
	arrRef := stack.PopRef()
...
func (load *LALOAD) Execute(frame *Frame) {
	stack := frame.OperandStack()
	index := stack.PopInt()
	arrRef := stack.PopRef()
...
func (load *SALOAD) Execute(frame *Frame) {
	stack := frame.OperandStack()
	index := stack.PopInt()
	arrRef := stack.PopRef()
